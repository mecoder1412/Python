...
while True:
    ...
    if results.multi_hand_landmarks and results.multi_handedness:
        for i, hand_landmarks in enumerate(results.multi_hand_landmarks):
            ...
            if hand_label == "Right" and volume:  # Control volume
                ...
                cv2.putText(img, f"Volume: {int(np.interp(distance, [30, 300], [0, 100]))}%", 
                            (40, 450), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 3)

            elif hand_label == "Left":  # Control brightness
                ...
                cv2.putText(img, f"Brightness: {int(brightness)}%", 
                            (90, 450), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 3)
